...
.hourglass {
	display: block;
	background: var(--bg, #2c2b2f);
	margin: 3em auto;
	width: 2em;
	height: 4em;
	animation: hourglass 1.25s linear infinite;
...
@keyframes hourglass {
	0% {
		...
		box-shadow: inset $fill 0 -0 0 0, inset var(--bg, #2c2b2f) 0 -2em 0 0, inset $fill 0 -4em 0 0;
	}
	80% {
		transform: rotate(0deg);
		box-shadow: inset $fill 0 -2em 0 0, inset var(--bg, #2c2b2f) 0 -2em 0 0, inset $fill 0 -2em 0 0;
	}
	100% {
